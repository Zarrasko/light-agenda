...
// Scans a QR code containing just the raw API key (generate one offline - see this tool's
// README - so the key never touches a third-party web service).
class PulseQrScannerScreen(
